...
// NewUSDFuturesAllBookTickerWebsocketClient Factory function
func NewUSDFuturesAllBookTickerWebsocketClient(streams ...string) *FuturesAllBookTickerWebsocketClient {
	c := new(FuturesAllBookTickerWebsocketClient)
...
func (u *FuturesAllBookTickerWebsocketClient) handleMessage(msg []byte) (interface{}, error) {
