...
// NewUSDFuturesSymbolMiniTickerWebsocketClient Factory function
func NewUSDFuturesSymbolMiniTickerWebsocketClient(streams ...string) *FuturesSymbolMiniTickerWebsocketClient {
	c := new(FuturesSymbolMiniTickerWebsocketClient)
...
func (u *FuturesSymbolMiniTickerWebsocketClient) handleMessage(msg []byte) (interface{}, error) {
