...
// NewUSDFuturesContinuesCandlestickWebsocketClient Factory function
func NewUSDFuturesContinuesCandlestickWebsocketClient(streams ...string) *FuturesContinuesCandlestickWebsocketClient {
