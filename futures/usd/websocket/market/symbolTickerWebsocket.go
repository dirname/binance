...
// NewUSDFuturesSymbolTickerWebsocketClient Factory function
func NewUSDFuturesSymbolTickerWebsocketClient(streams ...string) *FuturesSymbolTickerWebsocketClient {
	c := new(FuturesSymbolTickerWebsocketClient)
...
func (u *FuturesSymbolTickerWebsocketClient) handleMessage(msg []byte) (interface{}, error) {
