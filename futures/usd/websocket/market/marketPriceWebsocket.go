...
// NewUSDFuturesMarketPriceWebsocketClient Factory function
func NewUSDFuturesMarketPriceWebsocketClient(streams ...string) *FuturesMarketPriceWebsocketClient {
	c := new(FuturesMarketPriceWebsocketClient)
...
func (u *FuturesMarketPriceWebsocketClient) handleMessage(msg []byte) (interface{}, error) {
