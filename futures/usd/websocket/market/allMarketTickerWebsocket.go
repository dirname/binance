...
// NewUSDFuturesAllMarketTickerWebsocketClient Factory function
func NewUSDFuturesAllMarketTickerWebsocketClient(streams ...string) *FuturesAllMarketTickerWebsocketClient {
